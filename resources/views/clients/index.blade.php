        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">The total of all clients is <b>200</b>.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4 d-flex justify-content-end">
                <a href="/clients/create">
                    <button class="btn btn-outline-dark m-3">Add new client</button>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach ($clients as $client)
                                <tr>
                                    <td>{{ $client->id }}</td>
                                    <td><img src="{{ url('storage/' . $client->user->user_pic) }}" alt="client_img"
